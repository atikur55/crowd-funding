          ...
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              ...
              <p className="max-w-xl mb-4  text-base text-gray-200 md:text-lg">
                ...
                Impedit praesentium quisquam id alias, quaerat accusantium?
              </p>
              <Link
                href="/"
                ...
                <form className="space-y-4">
                  <div className="mb-1 sm:mb-2">
                    ...
                    <input
                      ...
                      required
                      type="text"
                      className="flex-grow w-full h-12 px-4 transition duration-200 bg-white border border-gray-300 rounded shadow-sm appearance-none focus:border-purple-400 focus:outline-none focus:shadow-none"
                      id="title"
                      name="title"
                    />
                  </div>
                  ...
                  <div className="mt-4 mb-2 sm:mb-4">
                    <button
                      ...
                      className="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none background w-full mb-2"
                    >
                      Create Campaign
                    </button>
